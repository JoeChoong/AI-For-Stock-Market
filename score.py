...
def init():
    global model
    model_path = "src/lgb_cat_model_v8.pkl"
...
def score(input_json):
    ...
    full = {'Question_code': {0: 'Q055_A',
        ...
        243: 'In order to support your career development, your client gives you a number of business cards of his business partners for you to conduct marketing activities with them. You would:-Thank for the client�s support and actively conduct marketing activities with these persons',
        ...
        246: 'A client discloses to you that he had suffered from certain illness, but requests you not to state it in the insurance application forms. You would:-Accede to the client�s request and not disclose the illness in the application forms',
...
def run(request):
    ...
    dict_input = json.loads(reqBody)
    result = score(dict_input)
    return R.ok(result)
